...
<Image src={storybookScreenshot} alt="Kubrick UI Storybook" loading="eager" />
...
<Image src={storybookActionsScreenshot} alt="Kubrick UI Storybook Actions tab" loading="eager" />
